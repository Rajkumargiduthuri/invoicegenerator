                                        ...
                                        <tbody id="product_tbody">
                                            <tr>
                                                ...
                                                while ($data = mysqli_fetch_assoc($result2)) {
                                                    ...
                                                    echo "<td><input type='text'  name='discount[]' class='form-control discount' value='" . $data['Discount'] . "'></td>";
